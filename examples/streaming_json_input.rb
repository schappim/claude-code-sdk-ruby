...
messages = [
  ...
  ClaudeCodeSDK::JSONLHelpers.create_user_message("Can you help me understand how modules work?"),
  ClaudeCodeSDK::JSONLHelpers.create_user_message("Show me a practical example of a module.")
]
...
conversation_messages = ClaudeCodeSDK::JSONLHelpers.create_conversation(
...
ClaudeCodeSDK.stream_json_query(conversation_messages) do |message|
  case message
  when ClaudeCodeSDK::AssistantMessage
    message.content.each do |block|
...
ClaudeCodeSDK.stream_json_query(custom_messages) do |message|
...
tutorial_messages = ClaudeCodeSDK::JSONLHelpers.create_conversation(
...
ClaudeCodeSDK.stream_json_query(tutorial_messages, options: options) do |message|
  case message
  when ClaudeCodeSDK::AssistantMessage
    message.content.each do |block|
      if block.is_a?(ClaudeCodeSDK::TextBlock)
